...
class Exp(PPYOLOE_Method_Exp):
    def __init__(self):
        ...
        # custom dataset
        self.num_classes = 8
        self.data_dir = '../billiards_coco'
        self.cls_names = 'class_names/billiards_classes.txt'
        self.ann_folder = "annotations"
        self.train_ann = "train.json"
        self.val_ann = "val.json"
        self.train_image_folder = "train"
        self.val_image_folder = "val"
        ...
        # -----------------  testing config ------------------ #
        self.eval_height = 1280
        self.eval_width = 1280
