...
class Exp(PPYOLOE_Method_Exp):
    def __init__(self):
        ...
        # custom dataset
        self.num_classes = 9
        self.data_dir = '../../datasets/hydatid/split_radial/no_radial_line'
        self.cls_names = 'class_names/hytadit_classes.txt'
        self.ann_folder = "annotations"
        self.train_ann = "train.json"
        self.val_ann = "test.json"
        self.train_image_folder = "images/train2017"
        self.val_image_folder = "images/test2017"
